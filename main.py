...
from crud import add_book, update_book, get_book, delete_book, add_member, get_member, delete_member, add_loan, \
    update_loan, get_loan, delete_loan, get_all_books_neo4j, get_all_books_mongo, get_all_books_neo4j2
...
# Update the book
update_book(book_id=704, title="Updated Sample Book", authors=["Author 3", "Author 4"], year=2023)

# Retrieve the book
book = get_book(book_id=704)
...
# Add a loan
add_loan(loan_id=12, book_id="B002", member_id=11, loan_date=datetime.now())
